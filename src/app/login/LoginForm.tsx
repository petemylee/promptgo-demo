            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center">
                <label className="inline-flex cursor-pointer items-center gap-2.5 text-sm text-slate-600">
                  <input
                    ...
                    className="h-4 w-4 rounded border-slate-300 text-[#0076c3] focus:ring-[#0076c3]"
                  />
                  จดจำฉันไว้ในระบบ
                </label>
              </div>
              ...
              <div className="relative py-1">
                ...
                <div className="relative flex justify-center">
                  <span className="bg-white px-3 text-xs text-slate-500">หรือเข้าสู่ระบบด้วย LINE</span>
                </div>
              </div>
